...
from langclaw.config.schema import SlackChannelConfig, secret_value
...
class SlackChannel(BaseChannel):
    ...
    async def start(self, bus: BaseMessageBus) -> None:
        ...
        app = AsyncApp(token=secret_value(self._config.bot_token))
        self._app = app
        ...
        handler = AsyncSocketModeHandler(app, secret_value(self._config.app_token))
        ...
        for file_info in files:
            ...
            try:
                ...
                if url_private and self._app and aiohttp:
                    headers = {"Authorization": f"Bearer {secret_value(self._config.bot_token)}"}
